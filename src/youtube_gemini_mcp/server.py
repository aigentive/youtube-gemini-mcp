        ...
        if result["success"] and source_type == "youtube_url":
            ...
            if metadata_result["success"]:
                ...
                manager.update_session(session_id, {
                    "youtube_metadata": metadata_result["video_metadata"]
                })
...
def analyze_local_video(
    ...
    try:
        ...
        client = get_gemini_client()
        result = client.analyze_uploaded_video(
            file_id=file_id,
            user_prompt=prompt
        )
...
def get_session_status(session_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": str(e),
            "error_type": "session_status_error"
        }
...
def validate_youtube_url(url: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if validation["valid"]:
            ...
            compatibility = validator.check_gemini_compatibility(validation["normalized_url"])
    ...
    try:
        ...
        return {
            ...
            "components": {
                ...
                "youtube_validator": "initialized" if youtube_validator else "not_initialized",
                "files_uploader": "initialized" if files_uploader else "not_initialized"
            },
            "environment": {
